...
A validating instance of rmcd uses information in the configuration file
...
consensus to succeed, otherwise different instances of rmcd will get 
...
*  A pull request is created and the new code is folded into a rmcd build 
