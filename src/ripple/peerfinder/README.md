...
**rmcd software**. Each peer maintains multiple outgoing connections and
...
**rmcd** is launched, the existing Bootcache database data is accessed and
...
outgoing connections to foreign peers. This security feature helps rmcd
