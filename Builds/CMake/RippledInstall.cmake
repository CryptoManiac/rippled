...
if (is_root_project)
  install (TARGETS rmcd RUNTIME DESTINATION bin)
  set_target_properties(rmcd PROPERTIES INSTALL_RPATH_USE_LINK_PATH ON)
  install (
    FILES
  ...
  install(CODE "
    ...
    endmacro()
    copy_if_not_exists(\"${CMAKE_CURRENT_SOURCE_DIR}/cfg/rmcd-example.cfg\" etc rmcd.cfg)
